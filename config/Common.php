...
class Common extends Config
{
    public function define(Container $di)
    {
        ...
        $di->params['Aura\Filter\Rule\Locator\SanitizeLocator']['factories'] = array(
            ...
            'equalToField'          =>  $di->lazyNew('Aura\Filter\Rule\Sanitize\EqualToField'),
            'equalToValue'          =>  $di->lazyNew('Aura\Filter\Rule\Sanitize\EqualToValue'),
            ...
            'strictEqualToField'    =>  $di->lazyNew('Aura\Filter\Rule\Sanitize\StrictEqualToField'),
            'strictEqualToValue'    =>  $di->lazyNew('Aura\Filter\Rule\Sanitize\StrictEqualToValue'),
            ...
            'valueIfBlank'          =>  $di->lazyNew('Aura\Filter\Rule\Sanitize\ValueIfBlank'),
